        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserInSessions_Sessions_SessionId",
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("04f53320-61cb-4683-9b5d-f72925b69162"), "Admin" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("df668d0c-21b0-4fa5-a9b7-4797b3841176"), "User" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInSessions_SessionId",
